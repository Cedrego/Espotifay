...
public class ventana extends javax.swing.JFrame {
     ...
     */
    public ventana() {
        Logica.InfiniteVoid gojo = new Logica.InfiniteVoid(IC);
        initComponents();
    }
...
//                            Logica.CrearLista crearlista = new CrearLista(IC, name, Tipo, GoC);   
                  ...
                  if("Particular".equals(Tipo)){
                     String nom = ComboBox1.getSelectedItem().toString();//nick del cliente
                        ...
                        if(existe == true){//no existe el tema en esa lista de temas de esa lista particular del cliente
                            Logica.QuitarTemasLista quitarTemaLista = new QuitarTemasLista( Tipo, NomPlay, NomTema, nom);   
            ...
            case 8:
                ...
                Logica.AltaSeguirUsuario seguirUsr = new Logica.AltaSeguirUsuario(IC, cliente, seguidor);
                Text10.setVisible(false);
            ...
            case 9:
                ...
                if(seguidor1.isEmpty()){
                   ...
                   Logica.AltaDejarSeguir noSeguir = new Logica.AltaDejarSeguir(IC, usuario1, seguidor1);
                   Text10.setVisible(false);
