...
public class DataArtista  {
    ...
    private List<DataCliente> DataseguidoPorA;
    ...
    public DataArtista(String nick, String nom, String ape, String mail, DTFecha fech, String bio, String webSite){
        this.nickname = nick;
        this.nombre = nom;
        this.apellido = ape;
        this.correo = mail;
    ...
    public void setDataseguidoPorA(List<DataCliente> DataseguidoPorA) {
    ...
    public List<DataCliente> getDataseguidoPorA() {
